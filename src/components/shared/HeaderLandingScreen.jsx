...
export default function HeaderLandingScreen() {
    useEffect(() => {
        const use = async () => {
    ...
    return (
        <>
            ...
            {/* Start Before login NavBar */}
            <header className='top-nav'>
                <div className='container-lg mx-auto px-3 shadow-lg'>
                    <nav
                        className="relative flex w-full items-center justify-between py-5"
                        data-te-navbar-ref>
                        <div class="w-full flex-wrap items-center justify-between px-3 container">
                            <div class="flex justify-between items-center gap-5" id="">
                                <div className='flex gap-4 items-center'>
                                    <button
                                        class="border-0 bg-transparent px-2 text-xl transition-shadow duration-150 ease-in-out"
                                        type="button"
                                    ><Image src="./images/burger-menu.svg" alt="" width={25} height={25} /></button>
                                ...
                                <div className='flex gap-5'>
                                    <Link href=""><Image src="./images/icon-bell.svg" width={18} height={20}/></Link>
                                    <Link href=""><Image src="./images/icon-patient.svg" width={18} height={20}/></Link>
                                    <Link href=""><Image src="./images/icon-doctor.svg" width={18} height={20}/></Link>
                                </div>
                            </div>
                        </div>
                    </nav>
            ...
            <header style={{ display: 'none' }}>
                <nav
                    class="top-nav relative flex w-full items-center justify-between py-4 shadow-lg hover:text-neutral-700 focus:text-neutral-700 md:flex-wrap md:justify-start"
                    data-te-navbar-ref>
