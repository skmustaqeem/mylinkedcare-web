...
const UpdatePatient = ({ open, setOpen ,initialValues}) => { 
    const validationSchema = Yup.object().shape({
        ...
        aadhar_number: Yup.string().required('aadhar number Required'),
        gender: Yup.string().required('gender Required'),
    });
    const onSubmit = async (values, helpers) => {
        const payload = { ...values }
        const res = await ApiCall({ url: Constants.API_ENDPOINTS.UPDATE_PATIENT, body: payload, method: 'PATCH' })
        if (res.status) {
                                ...
                                <div>
                                    <div
                                        ...
                                        <h5
                                            ...
                                            id="exampleModalLabel">Update Patient</h5>
                                        <button
                                            type="button"
                                                        ...
                                                        <form onSubmit={handleSubmit}>
                                                            ...
                                                            <div className="mb-5">
                                                                <div className="grid grid-cols-1 gap-2">
                                                                    ...
                                                                    <FormikForm.Input label="Aadhar Number" name="aadhar_number" type="text" />
                                                                    <FormikForm.RadioGroup label="Gender" name="gender" options={gender} value="M"/>
                                                                </div>
                                                            </div>
                                                            <div
